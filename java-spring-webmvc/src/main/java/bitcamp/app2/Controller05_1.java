...
public class Controller05_1 {
  ...
  public Controller05_1() {
    ...
    list.add(new Board(11, "제목입니다11", "내용", "홍길동11", 20, Date.valueOf("2019-8-1")));
    list.add(new Board(12, "제목입니다12", "내용", "홍길동12", 21, Date.valueOf("2019-9-1")));
    list.add(new Board(13, "제목입니다13", "내용", "홍길동13", 22, Date.valueOf("2019-10-1")));
  }
